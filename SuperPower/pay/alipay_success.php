...
<head>
	...
	<link href="../app/{php echo str_replace('./', '', url('utility/style'))}" rel="stylesheet">
...
<button type="button" class="btn btn-success" style="width:400px;margin-top:20px">支付成功，请进入企鹅造饭微信服务号查看</button>
</body>
</html>