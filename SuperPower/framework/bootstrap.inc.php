...
if(!empty($upload['image'])){
	$_W['config']['upload']['image'] = array_merge($_W['config']['upload']['image'], $upload['image']);
}
if(!empty($upload['audio'])){
	$_W['config']['upload']['audio'] = array_merge((array)$_W['config']['upload']['audio'], $upload['audio']);
}
unset($upload);
